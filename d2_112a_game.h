...
/**/
PATCH(0x44081, LE_BYTES(SAVE_SIZE + 0x4))
PATCH(0x440AA, LE_BYTES(SAVE_SIZE + 0x14))
PATCH(0x440B2, LE_BYTES(SAVE_SIZE))
PATCH(0x440BE, LE_BYTES(SAVE_SIZE + 0x20))
PATCH(0x44130, LE_BYTES(SAVE_SIZE + 0x4))
PATCH_ORIG(0x44081, 0x04, 0x20, 0x00, 0x00)
PATCH_ORIG(0x440AA, 0x14, 0x20, 0x00, 0x00)
PATCH_ORIG(0x440B2, 0x00, 0x20, 0x00, 0x00)
PATCH_ORIG(0x440BE, 0x20, 0x20, 0x00, 0x00)
PATCH_ORIG(0x44130, 0x04, 0x20, 0x00, 0x00)
